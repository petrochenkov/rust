...
mod desc {
    ...
    pub const parse_linker_flavor: &str = super::LegacyLinkerFlavor::one_of();
...
mod parse {
    ...
    pub(crate) fn parse_linker_flavor(
        slot: &mut Option<LegacyLinkerFlavor>,
        v: Option<&str>,
    ) -> bool {
        match v.and_then(LegacyLinkerFlavor::from_str) {
...
options! {
    ...
    linker_flavor: Option<LegacyLinkerFlavor> = (None, parse_linker_flavor, [UNTRACKED],
        "linker flavor"),
