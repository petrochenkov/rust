...
fn bar(x: i32) {
    ...
    //~^ ERROR dstats. parent: Other, stmts: OneWithoutTail, delegate_to: Other, args_match: Different, args_preproc: true, ret_match: Different, callee_has_self: true, caller_has_self: false, same_name: false, ret_postproc: true.
    //~| ERROR dstats. parent: Other, stmts: OneWithoutTail, delegate_to: Other, args_match: Different, args_preproc: false, ret_match: Different, callee_has_self: false, caller_has_self: false, same_name: false, ret_postproc: true.
}
